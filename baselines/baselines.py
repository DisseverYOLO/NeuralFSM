...
def llm_debate(task):
    ...
    num_agents = 2
    num_rounds = 3
    agents = [LLM(system_prompt="You are an intelligent agent participating in a debate. Consider other viewpoints carefully and provide clear, reasoned responses.",use_azure=False) for _ in range(num_agents)]
    ...
    final_agent = LLM(system_prompt="You are a judge tasked with analyzing multiple viewpoints and providing a final, well-reasoned conclusion.",use_azure=False)
