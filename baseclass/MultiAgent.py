...
try:
    ...
    print("Warning: OpenAI not installed. Some features may not work.")
    OpenAI = None
...
class MultiAgentSystem:
    ...
    def initialize_agents(self):
        for agent_id, agent in self.agents.items():
            ...
            self.llms[agent_id] = LLM(system_prompt=updated_agent['system_prompt'], use_azure=False)
